          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link
                  className={`nav-link ${
                    isActive("/women") ? "text-purple-600" : ""
                  }`}
                  to="/women"
                  style={
                    isActive("/women")
              ...
              <li className="nav-item">
                <Link
                  className={`nav-link ${
                    isActive("/living") ? "text-purple-600" : ""
                  }`}
                  to="/living"
                  style={
                    isActive("/living")
              ...
              <li className="nav-item">
                <Link
                  className={`nav-link ${
                    isActive("/jewelery") ? "text-purple-600" : ""
                  }`}
                  to="/jewelery"
                  style={
                    isActive("/jewelery")
